...
| | |
|---|---|
| **근거** | 모든 산출물에 출처가 붙습니다. 원문 인용부터 SQL Diff까지. |
| **승인** | 담당자의 검토·승인이 워크플로에 들어 있습니다(MCP Elicitation). |
| **감사** | 모델·근거·승인·버전이 기록됩니다. RBAC·PII 마스킹·온프레미스. |
